...
const TARGET = new URL("../src/data/person.snapshot.json", import.meta.url);
...
if (process.argv.includes("--check")) {
	...
	if (committed !== latest) {
		console.error(
			"✗ src/data/person.snapshot.json is stale.\n" +
	...
	console.log("✓ Refreshed src/data/person.snapshot.json");
}
